...
{
    [super validDateFormDateComponents:startDateComp toDateComponents:endDateComp];
//    [self rebulitItem];
...
{
    NSString *dateStr = [NSString stringWithFormat:@"%lu年%lu月",self.currentComponents.year,self.currentComponents.month];
